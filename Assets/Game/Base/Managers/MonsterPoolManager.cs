...
namespace Base.Data
{
    public class MonsterPoolManager : MonoBehaviour,IGameSystem
    {
        ...
        /// <summary> 몬스터 풀에서 오브젝트 대여</summary>
        /// <param name="key">가져올 몬스터의 키</param>
        public GameObject UsePool(int key)
        {
            GameObject obj = poolDic[key].UsePool();
            return obj;
        }
        /// <summary> 사용한 오브젝트 반납</summary>
        /// <param name="key">반납할 몬스터 오브젝트 키</param>
        /// <param name="returnObj">반납할 오브젝트</param>
