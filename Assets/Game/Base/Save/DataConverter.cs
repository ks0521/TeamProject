...
public static class DataConverter
{
    ...
    public static GameSaveData RuntimeToSave(RuntimeData runData)
    {
        GameSaveData saveData = new()
        {
            stageProgress =
            {
                curNormalStage = runData.stageProgress.curNormalStage,
                curNormalChapter = runData.stageProgress.curNormalChapter,
                maxClearStage = runData.stageProgress.maxClearStage,
                maxClearChapter = runData.stageProgress.maxClearChapter
            },
            currencyData =
            {
    ...
    public static RuntimeData SaveToRuntime(GameSaveData saveData)
    {
        RuntimeData runData = new RuntimeData
        {
            stageProgress =
            {
                curNormalStage = saveData.stageProgress.curNormalStage,
                curNormalChapter = saveData.stageProgress.curNormalChapter,
                maxClearStage = saveData.stageProgress.maxClearStage,
                maxClearChapter = saveData.stageProgress.maxClearChapter
            },
            currencyData =
            {
